      ...
      <div className="relative">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-20">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              ...
              <div className="rounded-2xl border border-purple-500/20 bg-purple-950/50 p-6">
                ...
                <p className="mb-4 text-sm text-gray-400">
                  Start your $1 first month and explore all features at your own pace.
                </p>
                <a
                  href="https://app.cloudrent.me/register"
                  className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300"
                >
                  Start $1 First Month <ArrowRight className="h-4 w-4" />
                </a>
              </div>
            </div>
            ...
            <div>
              <BookingWidget eventTypeSlug="demo" theme="dark" />
            </div>
          </div>
        </section>
      </div>
