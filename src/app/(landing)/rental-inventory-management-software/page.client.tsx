...
const painPoints = [
  {
    icon: Search,
    title: "You don't know what's available",
    subtitle: 'Guessing leads to double bookings',
    description:
      'Without a live inventory system, staff guess at availability and double bookings happen. CloudRent shows real-time stock.',
  },
  {
    icon: Package,
    title: 'Stock moves and disappears',
    subtitle: 'No tracking between jobs',
    description:
      'Equipment moves between jobs and locations without anyone tracking it. CloudRent logs every movement.',
  },
  {
    icon: Wrench,
    title: 'Maintenance causes conflicts',
    subtitle: 'Items under service get booked',
    description:
      'Items under service get booked anyway. CloudRent lets you hold assets for maintenance and block them from availability.',
  },
  {
    icon: Clock,
    title: 'Manual stocktakes waste time',
    subtitle: 'Counting is slow and inaccurate',
    description:
      'Counting stock by hand is slow and inaccurate. CloudRent tracks everything automatically as bookings are made and completed.',
  },
]
...
const features = [
  {
    ...
    description:
      'Live stock levels update instantly as bookings are made, changed, or cancelled.',
  },
  {
    icon: MapPin,
    title: 'Multi-location tracking',
    description:
      'Manage inventory across multiple depots, sites, or warehouses from one view.',
  },
  {
    icon: Wrench,
    title: 'Maintenance holds',
    description:
      'Take items offline for service without them showing as available to book.',
  },
  {
    icon: History,
    title: 'Asset history',
    description:
      'Every booking, movement, and service event recorded against each asset.',
  },
  {
    icon: Database,
    title: 'Automatic stock updates',
    description:
      'No manual adjustments. Stock levels follow your bookings automatically.',
  },
  {
    icon: BarChart3,
    title: 'Utilisation reporting',
    description:
      'Understand demand patterns, peak periods, and underperforming assets.',
  },
]

const stats = [
  { value: '0', label: 'Stock mismatches' },
  { value: 'Real-time', label: 'Availability' },
  { value: '100%', label: 'Asset visibility' },
  { value: 'Multi-location', label: 'Support' },
]
...
const howItWorks = [
  {
    ...
    description:
      'Add every item with quantity, location, pricing, and availability rules.',
    icon: Package,
  },
  {
    step: 2,
    title: 'Bookings update stock automatically',
    description:
      'When a booking is created, stock is reserved. When it closes, it is released.',
    icon: Calendar,
  },
  {
    step: 3,
    title: 'Hold items for maintenance',
    description:
      'Mark assets as under service and they are automatically blocked from booking.',
    icon: Wrench,
  },
  {
    step: 4,
    title: 'Report on utilisation',
    description:
      'See which items are in highest demand, which sit idle, and where to invest.',
    icon: BarChart3,
  },
]
...
const useCaseTypes = [
  ...
  { title: 'Furniture hire', description: 'Office and event' },
]

const mobileFeatures = [
  { icon: Package, label: 'Stock checks' },
  { icon: CheckCircle, label: 'Return confirmation' },
  { icon: Camera, label: 'Condition capture' },
  { icon: QrCode, label: 'Asset scanning' },
  { icon: Wifi, label: 'Real-time sync' },
]

export default function RentalInventoryClient() {
  const utmString = useUTMParams()
  const [lightboxImage, setLightboxImage] = useState<string | null>(null)

  useEffect(() => {
    trackLandingPageView('rental-inventory')
  }, [])

  const handleTrialClick = () => {
    trackLandingPageEvent('begin_trial', 'rental-inventory')
  }

  const handleDemoClick = () => {
    trackLandingPageEvent('book_demo', 'rental-inventory')
  }
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mb-6 text-4xl font-black leading-tight text-white md:text-5xl lg:text-6xl">
              Rental Inventory Management Software for{' '}
            ...
            <p className="mx-auto mb-8 max-w-2xl text-lg text-white/60 md:text-xl">
              Know exactly what you have, where it is, and when it is available.{' '}
              <strong className="text-white">
                CloudRent gives you live inventory visibility across every location and booking.
              </strong>
            </p>
          ...
          <div className="relative mx-auto mt-16 max-w-5xl">
            ...
            >
              <Image
                ...
                alt="CloudRent Pro rental inventory management software dashboard"
                width={1920}
                height={1032}
                className="w-full"
                priority
        ...
        <div className="mx-auto max-w-6xl px-5">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-black text-white md:text-4xl lg:text-5xl">
              Managing rental inventory manually{' '}
              <span className="bg-gradient-to-r from-purple-500 to-fuchsia-400 bg-clip-text text-transparent">
                doesn&apos;t scale.
              </span>
            </h2>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mb-4 text-3xl font-black text-white md:text-4xl">
                Live inventory visibility across your{' '}
                <span className="bg-gradient-to-r from-purple-500 to-fuchsia-400 bg-clip-text text-transparent">
                  entire operation
                </span>
              </h2>
              <p className="mb-6 text-lg text-white/60">
                From hire catalogues to maintenance holds, CloudRent keeps your stock accurate in
                real time.
              </p>
              <ul className="space-y-3 text-white/70">
                <li className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                  Real-time availability by item, category, and location
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                  Automatic stock updates as bookings are created and closed
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                  Maintenance holds that block items from being booked
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                  Full asset history — every booking, every movement
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="mt-0.5 h-5 w-5 shrink-0 text-green-500" />
                  Low stock alerts and utilisation reporting
                </li>
              </ul>
            </div>
            <div
            ...
            >
              ...
              <Image
                ...
                alt="CloudRent Pro inventory management view"
                width={1200}
                height={900}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            >
              ...
              <Image
                ...
                alt="CloudRent Crew mobile app for warehouse staff"
                width={1200}
                height={800}
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mb-6 text-lg text-white/60">
                CloudRent Crew lets warehouse staff check stock, confirm returns, and capture asset
                condition — all from their phone without touching the desktop system.
              </p>
      ...
      <section className="relative py-20">
        <div className="mx-auto max-w-4xl px-5 text-center">
          ...
          <blockquote className="mb-6 text-xl font-semibold leading-relaxed text-white md:text-2xl">
            We used to run stocktakes every week. Now the system tracks everything and we always
