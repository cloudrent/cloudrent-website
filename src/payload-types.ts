...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'cloudrent' | 'highImpact' | 'mediumImpact' | 'lowImpact';
    badge?: string | null;
...
export interface BenefitsBlock {
  ...
  benefits?:
    | {
        icon?: ('calendar' | 'creditCard' | 'shield' | 'zap' | 'users' | 'check') | null;
        title: string;
        description: string;
        id?: string | null;
      }[]
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ShipFastBlock".
 */
export interface ShipFastBlock {
  badge?: string | null;
  headline?: string | null;
  description?: string | null;
  stats?:
...
export interface Video {
  ...
  /**
   * Feature this video at the top of the videos page
   */
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        shipFast?: T | ShipFastBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ShipFastBlock_select".
 */
export interface ShipFastBlockSelect<T extends boolean = true> {
  badge?: T;
  headline?: T;
  description?: T;
  stats?:
